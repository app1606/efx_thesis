...
$EXAMPLESDIR = "/Users/nikita/Desktop/Diploma_Project/latte-integrale-1.7.4/latte-int-1.7.4/EXAMPLES";
...
if ($ENV{USE_INSTALLED_BINARY}) {
    $COUNT = "/Users/nikita/Desktop/Diploma_Project/latte-integrale-1.7.4/dest/bin/count";
}
else {
